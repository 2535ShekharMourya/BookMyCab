...
import com.example.bookmycar.NoInternet;
...
public class LoginByEmail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuth=FirebaseAuth.getInstance(); // used to initialize auth client
        rootRef= FirebaseDatabase.getInstance().getReference(); // use to connect to the realtime database
        mUser= mAuth.getCurrentUser();// use to retrieve the unique id for each new user
