...
public class ExpandedHistoryActivity extends AppCompatActivity implements OnMapReadyCallback, RoutingListener {
    GoogleMap mMap;
    ...
    private void payPalPayment() {
        ...
        Intent intent = new Intent(ExpandedHistoryActivity.this, PaymentActivity.class);
        intent.putExtra(PayPalService.EXTRA_PAYPAL_CONFIGURATION, config);
