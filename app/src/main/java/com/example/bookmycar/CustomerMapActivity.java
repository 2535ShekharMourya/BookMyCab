...
import com.example.bookmycar.databinding.ActivityCustomerMapBinding;
...
public class CustomerMapActivity extends AppCompatActivity implements OnMapReadyCallback, RoutingListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        driverProfileImage = findViewById(R.id.driverProfileImg);
        ...
        local = findViewById(R.id.regular);
        group = findViewById(R.id.radioGroup);
        regularHighlight = findViewById(R.id.regularhighlight);
        premiumihilight = findViewById(R.id.premiumhighlight);
        ...
        request.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    mPickUpMarker = mMap.addMarker(new MarkerOptions().position(pickupLocation).title("Pickup Here").icon(BitmapDescriptorFactory.fromResource(R.mipmap.pickup1_foreground)));
